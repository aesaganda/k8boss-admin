...
This project has one maintainer. Enforcement is theirs to carry out — there is
no committee to escalate to, which is worth knowing before you report
something: response times are best-effort, the same as everything else
...
reported to **erensaganda@gmail.com**. All complaints will be reviewed and
