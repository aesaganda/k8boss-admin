...
def list_events(
    ...
    limit: int = Query(
        DEFAULT_LIMIT, ge=1, le=_SCAN_PAGE_SIZE * _MAX_SCAN_PAGES,
        description=(
    ...
    ``continue`` is always ``null`` here, and that is deliberate rather than an
...
__all__ = ["DEFAULT_LIMIT", "event_row", "list_events", "router"]
